...
export function LibraryScreen({ visible, allSearchTracks, setAllSearchTracks, playlists, setPlaylists, activePlaylistId, setActivePlaylistId, setQueue, selectTrack, playQueue }: LibraryScreenProps) {
